...
def parse_args():
    ...
    parser.add_argument("--ns", type=str, default='dens', help="rns,dns,dens,mix,ans")
    ...
    parser.add_argument("--warmup", type=float, default=300, help="weight for relevant factor")
    parser.add_argument("--gamma", type=float, default=0.4, help="weight for gating task")
    parser.add_argument("--eps", type=float, default=0.2, help="radius of noise ")
    ...
    parser.add_argument('--Ks', nargs='?', default='[20,15,10,5]',
    ...
    parser.add_argument(
        "--out_dir", type=str, default="./weights/baby/", help="output directory for model"
    )
